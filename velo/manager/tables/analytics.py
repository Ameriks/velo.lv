...
from velo.registration.models import Participant, Number
...
class ManageFindNumberViewTable(GetRequestTableKwargs, tables.Table):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._slugs = {
        obj.id: [p.participant_slug for p in Number.objects.filter(distance=obj).exclude(participant_slug='')] for obj
        in competition.get_distances()}
