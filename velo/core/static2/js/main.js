...
(function() {
  ...
  call_formset_function = function(row, container, type) {
    var field, function_name, j, len, ref;
  ...
  formset = function(containers) {
    var $container, $items, container, j, len, prefix, results, ret_obj;
    ret_obj = {};
    results = [];
  ...
  $(function() {
    ...
    $('table th input:checkbox').on('click', function() {
      var checkbox, j, len, ref, results;
      ref = $(this).closest('table').find('tr > td:first-child input:checkbox');
      results = [];
      for (j = 0, len = ref.length; j < len; j++) {
        checkbox = ref[j];
