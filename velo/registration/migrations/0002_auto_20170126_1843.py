...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='participant',
            name='where_heard',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='+', to='core.Choices', verbose_name='Kur uzzināja'),
        ),
        migrations.AddField(
            model_name='number',
            name='competition',
        ...
        migrations.AddField(
            ...
            name='competition',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Competition', verbose_name='Sacensības'),
        ),
        migrations.AddField(
            model_name='application',
            name='created_by',
