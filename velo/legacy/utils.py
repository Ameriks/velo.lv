...
# from velo.core.models import User, Choices, Competition, Distance, Insurance, CustomSlug
...
#
# from velo.payment.models import Price, DiscountCode, Payment, DiscountCampaign
# from velo.registration.models import Application, Participant
# from velo.results.models import LegacySEBStandingsResult, LegacyResult, HelperResults
