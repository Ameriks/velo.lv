...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'HelperResults', fields ['calculated_total']
        db.create_index(u'results_helperresults', ['calculated_total'])

        # Adding index on 'HelperResults', fields ['passage_assigned']
        db.create_index(u'results_helperresults', ['passage_assigned'])


    def backwards(self, orm):
        # Removing index on 'HelperResults', fields ['passage_assigned']
        db.delete_index(u'results_helperresults', ['passage_assigned'])

        # Removing index on 'HelperResults', fields ['calculated_total']
        db.delete_index(u'results_helperresults', ['calculated_total'])
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'ce59133f-26ce-4d8b-bbbd-85ec0c821f84'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'11850606-fbd8-4747-be98-964843b3ab58'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'89125fe5-e8d4-40bb-b08e-4f53b3807c47'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
