...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'HelperResults.stage_assigned'
        db.delete_column(u'results_helperresults', 'stage_assigned')

        # Adding field 'HelperResults.passage_assigned'
        db.add_column(u'results_helperresults', 'passage_assigned',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'HelperResults.stage_assigned'
        db.add_column(u'results_helperresults', 'stage_assigned',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Deleting field 'HelperResults.passage_assigned'
        db.delete_column(u'results_helperresults', 'passage_assigned')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'4cf5fd40-95dd-4bfa-a88d-4172ec0371e7'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'1fa820aa-21c8-4661-897a-aaeab0768b75'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'faf91ee7-f6c2-457b-a381-374eb32b9da1'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'results.helperresults': {
            ...
            'passage_assigned': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'results.lapresult': {
