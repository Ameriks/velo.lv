...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HelperResults'
        db.create_table(u'results_helperresults', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_helperresults_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_helperresults_set', null=True, to=orm['core.User'])),
            ...
            ('calculated_total', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('stage_assigned', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('is_manual', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('matches_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
        ))
        db.send_create_signal(u'results', ['HelperResults'])


    def backwards(self, orm):
        # Deleting model 'HelperResults'
        db.delete_table(u'results_helperresults')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'71e84a16-f585-4d69-bb80-fd478a5f69db'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'1cb9a4f0-579f-4c6f-8c15-e3e094fb835a'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'0959841b-4d35-4b6b-9603-74f005de11f2'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'results.helperresults': {
            ...
            'calculated_total': ('django.db.models.fields.FloatField', [], {'null': 'True', 'blank': 'True'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            ...
            'stage_assigned': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'results.lapresult': {
