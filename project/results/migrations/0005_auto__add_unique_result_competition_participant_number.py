...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Result', fields ['competition', 'participant', 'number']
        db.create_unique(u'results_result', ['competition_id', 'participant_id', 'number_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Result', fields ['competition', 'participant', 'number']
        db.delete_unique(u'results_result', ['competition_id', 'participant_id', 'number_id'])
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'d0ec718e-d965-447a-921d-56e59f24431d'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'5a571529-5714-424a-a816-69492a43744d'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'434552e5-c004-480a-94b1-e74098436978'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
