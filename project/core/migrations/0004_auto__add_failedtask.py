...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'core_failedtask', (
            ...
            ('exception_class', self.gf('django.db.models.fields.TextField')()),
            ('exception_msg', self.gf('django.db.models.fields.TextField')()),
            ('traceback', self.gf('django.db.models.fields.TextField')(null=True, blank=True)),
            ('celery_task_id', self.gf('django.db.models.fields.CharField')(max_length=36)),
            ('failures', self.gf('django.db.models.fields.PositiveSmallIntegerField')(default=1)),
        ))
        db.send_create_signal(u'core', ['FailedTask'])


    def backwards(self, orm):
        # Deleting model 'FailedTask'
        db.delete_table(u'core_failedtask')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'077b20bc-3067-411c-8347-1b9e39f5e1cf'", 'max_length': '36'}),
