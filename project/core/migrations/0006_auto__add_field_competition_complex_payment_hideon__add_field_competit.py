...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Competition.complex_payment_hideon'
        db.add_column(u'core_competition', 'complex_payment_hideon',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Competition.sms_text'
        db.add_column(u'core_competition', 'sms_text',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Competition.complex_payment_hideon'
        db.delete_column(u'core_competition', 'complex_payment_hideon')

        # Deleting field 'Competition.sms_text'
        db.delete_column(u'core_competition', 'sms_text')
    ...
    models = {
        ...
        u'core.failedtask': {
            'Meta': {'ordering': "('-updated_at',)", 'object_name': 'FailedTask'},
            'args': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'celery_task_id': ('django.db.models.fields.CharField', [], {'max_length': '36'}),
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'exception_class': ('django.db.models.fields.TextField', [], {}),
            'exception_msg': ('django.db.models.fields.TextField', [], {}),
            'failures': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'2e34307d-d3e8-4fe2-8a48-113a0ae308ee'", 'max_length': '36'}),
