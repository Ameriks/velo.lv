...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'InsuranceCompany.terms_doc'
        db.add_column(u'core_insurancecompany', 'terms_doc',
                      self.gf('django.db.models.fields.files.FileField')(default='', max_length=100, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'InsuranceCompany.terms_doc'
        db.delete_column(u'core_insurancecompany', 'terms_doc')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'eda30caa-dc46-407b-b107-ba38b06047be'", 'max_length': '36'}),
