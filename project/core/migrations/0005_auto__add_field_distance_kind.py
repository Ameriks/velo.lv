...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Distance.kind'
        db.add_column(u'core_distance', 'kind',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=1, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Distance.kind'
        db.delete_column(u'core_distance', 'kind')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'bc56b59b-a1c4-451a-a4be-412d9836478f'", 'max_length': '36'}),
