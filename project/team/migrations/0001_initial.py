...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'team_team', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_team_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_team_set', null=True, to=orm['core.User'])),
            ...
            ('shirt_image', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ...
            ('management_info', self.gf('django.db.models.fields.TextField')(blank=True)),
        ...
        db.create_table(u'team_member', (
            ...
            ('country', self.gf('django_countries.fields.CountryField')(max_length=2)),
            ('license_nr', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('legacy_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'team', ['Member'])

        # Adding model 'MemberApplication'
        db.create_table(u'team_memberapplication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team.Member'])),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Competition'])),
            ('kind', self.gf('django.db.models.fields.SmallIntegerField')(db_index=True)),
            ('participant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Participant'], null=True, blank=True)),
            ('participant_unpaid', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'memberapplication_unpaid_set', null=True, to=orm['registration.Participant'])),
            ('participant_potential', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name=u'memberapplication_potential_set', null=True, to=orm['registration.Participant'])),
            ('legacy_id', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'team', ['MemberApplication'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'MemberApplication'
        db.delete_table(u'team_memberapplication')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'bcb88ea7-d454-4f45-b9df-fb1bd27889b8'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'e2e2dbb3-d749-42c0-b9f4-6d4a0fddae58'", 'unique': 'True', 'max_length': '50'}),
