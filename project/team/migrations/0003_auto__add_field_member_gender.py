...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'team_member', 'gender',
                      self.gf('django.db.models.fields.CharField')(default='M', max_length=1, blank=True),
                      keep_default=False)
        for member in orm.Member.objects.all():
            if member.id in (1395, 2049, 2247, 2250, 2320, 2321):
                member.gender = 'F'
            else:
                try:
                    participant = orm['registration.Participant'].objects.filter(ssn=member.ssn)[0]
                    member.gender = participant.gender
                except:
                    member.gender = 'M'
            member.save()
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'team_member', 'gender')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'1129a26d-2850-4747-a6b9-00bf3f122ff7'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'d8b8c26d-d073-4691-8a8d-b1d84eb1eca6'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'d47126b4-23c3-42f9-9ed8-0b19eae1393e'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
