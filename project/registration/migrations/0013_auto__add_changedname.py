...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'ChangedName'
        db.create_table(u'registration_changedname', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
            ('new_slug', self.gf('django.db.models.fields.SlugField')(max_length=50)),
        ))
        db.send_create_signal(u'registration', ['ChangedName'])


    def backwards(self, orm):
        # Deleting model 'ChangedName'
        db.delete_table(u'registration_changedname')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'6a692301-f623-4b8b-8122-84a7fd012b3c'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'1f201591-537f-43a5-afae-9e1d7b360993'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'fa968a3c-26a4-4b88-9650-afae506727d3'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
