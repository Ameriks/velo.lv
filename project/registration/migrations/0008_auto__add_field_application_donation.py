...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.donation'
        db.add_column(u'registration_application', 'donation',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.donation'
        db.delete_column(u'registration_application', 'donation')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'cf247428-0079-4077-b6b9-2631533ce052'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'4bf1a0e2-5758-455b-92ef-62bf6f9c182f'", 'unique': 'True', 'max_length': '50'}),
