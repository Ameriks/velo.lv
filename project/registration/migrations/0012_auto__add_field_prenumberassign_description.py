...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreNumberAssign.description'
        db.add_column(u'registration_prenumberassign', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreNumberAssign.description'
        db.delete_column(u'registration_prenumberassign', 'description')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'f1037894-67f0-4975-be9f-d3cb2e45fbaf'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'0b5e03f5-86f7-416e-8799-83e2a98d2e21'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'060e0429-2eab-41d3-822e-438ec8c07c36'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
