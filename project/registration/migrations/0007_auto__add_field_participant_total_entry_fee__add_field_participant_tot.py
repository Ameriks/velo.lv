...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.total_entry_fee'
        db.add_column(u'registration_participant', 'total_entry_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'Participant.total_insurance_fee'
        db.add_column(u'registration_participant', 'total_insurance_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.total_entry_fee'
        db.delete_column(u'registration_participant', 'total_entry_fee')

        # Deleting field 'Participant.total_insurance_fee'
        db.delete_column(u'registration_participant', 'total_insurance_fee')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'9a0a6181-6945-4c4e-a596-53d87c4df09b'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'283d0561-6763-41c0-bd63-689ca2d3e19a'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.prenumberassign': {
            'Meta': {'object_name': 'PreNumberAssign'},
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'distance': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Distance']"}),
            'group_together': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'number': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'}),
            'participant_slug': ('django.db.models.fields.SlugField', [], {'max_length': '50', 'blank': 'True'}),
            'segment': ('django.db.models.fields.IntegerField', [], {'null': 'True', 'blank': 'True'})
        },
        u'sitetree.tree': {
