...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'PreNumberAssign.group_together'
        db.add_column(u'registration_prenumberassign', 'group_together',
                      self.gf('django.db.models.fields.SlugField')(max_length=50, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'PreNumberAssign.group_together'
        db.delete_column(u'registration_prenumberassign', 'group_together')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'aeacc3fa-e7ce-4ad7-9b8c-b5d8496b0da8'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'726dbe87-c346-4ce0-a151-c5549bd289b0'", 'unique': 'True', 'max_length': '50'}),
