...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Application.invoice_show_names'
        db.add_column(u'registration_application', 'invoice_show_names',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Application.invoice_show_names'
        db.delete_column(u'registration_application', 'invoice_show_names')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'9c3ea745-0938-4302-8dcb-18a8cb5c0406'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'dbfa5e7a-4027-4313-a486-ae2dda896e3b'", 'unique': 'True', 'max_length': '50'}),
