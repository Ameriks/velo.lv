...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.final_price'
        db.add_column(u'registration_participant', 'final_price',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.final_price'
        db.delete_column(u'registration_participant', 'final_price')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'3a94f55f-75b1-4d9c-a02b-bf5325ed0696'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'5592e405-36cc-4b3c-be8b-7c121935cf39'", 'unique': 'True', 'max_length': '50'}),
