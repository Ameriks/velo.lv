...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PreNumberAssign'
        db.create_table(u'registration_prenumberassign', (
            ...
            ('segment', self.gf('django.db.models.fields.IntegerField')(null=True, blank=True)),
            ('participant_slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
        ))
        db.send_create_signal(u'registration', ['PreNumberAssign'])


    def backwards(self, orm):
        # Deleting model 'PreNumberAssign'
        db.delete_table(u'registration_prenumberassign')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'33d19367-7584-4135-9e2c-27b8823c74ae'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'f590ac25-db3d-4624-878f-dcac4b2add09'", 'unique': 'True', 'max_length': '50'}),
