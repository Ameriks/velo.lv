...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CompanyApplication'
        db.create_table(u'registration_companyapplication', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_companyapplication_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_companyapplication_set', null=True, to=orm['core.User'])),
            ...
            ('code', self.gf('django.db.models.fields.CharField')(default='96df8479-53f3-46e6-a240-69b0b460b5f6', unique=True, max_length=50)),
            ('team_name', self.gf('django.db.models.fields.CharField')(max_length=50)),
            ('email', self.gf('django.db.models.fields.EmailField')(max_length=75)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
        ))
        db.send_create_signal(u'registration', ['CompanyApplication'])

        # Adding model 'CompanyParticipant'
        db.create_table(u'registration_companyparticipant', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_companyparticipant_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_companyparticipant_set', null=True, to=orm['core.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('application', self.gf('django.db.models.fields.related.ForeignKey')(related_name=u'participant_set', to=orm['registration.CompanyApplication'])),
            ('team_member', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['team.Member'], null=True, blank=True)),
            ...
            ('bike_brand2', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('slug', self.gf('django.db.models.fields.SlugField')(max_length=50, blank=True)),
        ))
        db.send_create_signal(u'registration', ['CompanyParticipant'])

        # Adding field 'Participant.company_participant'
        db.add_column(u'registration_participant', 'company_participant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.CompanyParticipant'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'CompanyApplication'
        db.delete_table(u'registration_companyapplication')

        # Deleting model 'CompanyParticipant'
        db.delete_table(u'registration_companyparticipant')

        # Deleting field 'Participant.company_participant'
        db.delete_column(u'registration_participant', 'company_participant_id')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'5f6f17f8-b97d-4e8d-a930-17cb818e48f2'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'61511ca4-dae7-45c9-a6ad-bca4619638d2'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'f3c349b1-fc99-4b6f-b12b-4a436896dd31'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
