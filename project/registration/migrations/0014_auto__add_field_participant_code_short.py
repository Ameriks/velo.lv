...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.code_short'
        db.add_column(u'registration_participant', 'code_short',
                      self.gf('django.db.models.fields.CharField')(db_index=True, default='', max_length=20, blank=True),
                      keep_default=False)
        last_id = orm.Participant.objects.order_by('-id')[0].id
        for rec_id in range(1, last_id+1):
            hashids = Hashids(salt=settings.SECRET_KEY2, min_length=7, alphabet=settings.HASH_ALPHABET)
            orm.Participant.objects.filter(id=rec_id).update(code_short=hashids.encode(rec_id))



    def backwards(self, orm):
        # Deleting field 'Participant.code_short'
        db.delete_column(u'registration_participant', 'code_short')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'98886322-8390-429b-8585-88ef1afe7fe1'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'1efc33db-475a-4da7-8434-e4ecfb54f1c4'", 'unique': 'True', 'max_length': '50'}),
        ...
        u'registration.changedname': {
            'Meta': {'object_name': 'ChangedName'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'registration.companyapplication': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'0e65cc0d-0483-475c-aa63-5b1a57a365c0'", 'unique': 'True', 'max_length': '50'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']"}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
        ...
        u'registration.participant': {
            ...
            'code_short': ('django.db.models.fields.CharField', [], {'db_index': 'True', 'max_length': '20', 'blank': 'True'}),
