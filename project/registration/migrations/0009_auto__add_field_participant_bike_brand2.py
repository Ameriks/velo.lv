...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.bike_brand2'
        db.add_column(u'registration_participant', 'bike_brand2',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        for choice in orm['core.Choices'].objects.filter(kind=10):
            orm.Participant.objects.filter(bike_brand_id=choice.id).update(bike_brand2=choice.title)

    def backwards(self, orm):
        # Deleting field 'Participant.bike_brand2'
        db.delete_column(u'registration_participant', 'bike_brand2')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'06b31049-bfe1-4096-b7c7-6445f8a1b3b0'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'382c8d15-6c9d-4c69-9a44-e3fea63fb630'", 'unique': 'True', 'max_length': '50'}),
