...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Participant.is_paying'
        db.add_column(u'registration_participant', 'is_paying',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Participant.is_paying'
        db.delete_column(u'registration_participant', 'is_paying')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'1c14ed9c-ccb0-4da0-a201-f343dde550e1'", 'max_length': '36'}),
        ...
        u'registration.application': {
            ...
            'code': ('django.db.models.fields.CharField', [], {'default': "'5926584d-ab52-434c-9b0f-ae3b8ebccb8d'", 'unique': 'True', 'max_length': '50'}),
