...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Payment.donation'
        db.add_column(u'payment_payment', 'donation',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Payment.donation'
        db.delete_column(u'payment_payment', 'donation')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'c425fec2-30e4-43dd-8198-8fbb215625dd'", 'max_length': '36'}),
        ...
        u'payment.paymentchannel': {
            ...
            'payment_channel': ('django.db.models.fields.CharField', [], {'default': "u'LKDF'", 'max_length': '20'}),
            'title': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        u'payment.price': {
