...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DiscountCampaign.discount_entry_fee_percent'
        db.add_column(u'payment_discountcampaign', 'discount_entry_fee_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'DiscountCampaign.discount_entry_fee'
        db.add_column(u'payment_discountcampaign', 'discount_entry_fee',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'DiscountCampaign.discount_insurance_percent'
        db.add_column(u'payment_discountcampaign', 'discount_insurance_percent',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)

        # Adding field 'DiscountCampaign.discount_insurance'
        db.add_column(u'payment_discountcampaign', 'discount_insurance',
                      self.gf('django.db.models.fields.DecimalField')(default=0.0, max_digits=20, decimal_places=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DiscountCampaign.discount_entry_fee_percent'
        db.delete_column(u'payment_discountcampaign', 'discount_entry_fee_percent')

        # Deleting field 'DiscountCampaign.discount_entry_fee'
        db.delete_column(u'payment_discountcampaign', 'discount_entry_fee')

        # Deleting field 'DiscountCampaign.discount_insurance_percent'
        db.delete_column(u'payment_discountcampaign', 'discount_insurance_percent')

        # Deleting field 'DiscountCampaign.discount_insurance'
        db.delete_column(u'payment_discountcampaign', 'discount_insurance')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'1cb98b5f-452a-41b8-bd61-d2d7675b5fd0'", 'max_length': '36'}),
