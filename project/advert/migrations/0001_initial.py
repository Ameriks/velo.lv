...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FlashBanner'
        db.create_table(u'advert_flashbanner', (
            ...
            ('converted', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('url', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'advert', ['FlashBanner'])


    def backwards(self, orm):
        # Deleting model 'FlashBanner'
        db.delete_table(u'advert_flashbanner')


    models = {
        u'advert.flashbanner': {
            'Meta': {'ordering': "('ordering',)", 'object_name': 'FlashBanner'},
            ...
            'converted': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'bd8b312b-6295-4df4-8ee6-91cc69478fab'", 'max_length': '36'}),
