...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Photo.is_vertical'
        db.add_column(u'gallery_photo', 'is_vertical',
                      self.gf('django.db.models.fields.NullBooleanField')(default=None, null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.width'
        db.add_column(u'gallery_photo', 'width',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)

        # Adding field 'Photo.height'
        db.add_column(u'gallery_photo', 'height',
                      self.gf('django.db.models.fields.IntegerField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Photo.is_vertical'
        db.delete_column(u'gallery_photo', 'is_vertical')

        # Deleting field 'Photo.width'
        db.delete_column(u'gallery_photo', 'width')

        # Deleting field 'Photo.height'
        db.delete_column(u'gallery_photo', 'height')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'050276ce-ce20-4652-8649-01dee9394c42'", 'max_length': '36'}),
