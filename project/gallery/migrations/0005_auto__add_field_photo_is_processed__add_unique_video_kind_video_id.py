...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'gallery_photo', 'is_processed',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding unique constraint on 'Video', fields ['kind', 'video_id']
        db.create_unique(u'gallery_video', ['kind', 'video_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'Video', fields ['kind', 'video_id']
        db.delete_unique(u'gallery_video', ['kind', 'video_id'])

        # Deleting field 'Photo.is_processed'
        db.delete_column(u'gallery_photo', 'is_processed')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'da649dfa-cd5b-4e22-a013-c0f79bf8ea84'", 'max_length': '36'}),
        ...
        u'gallery.video': {
            'Meta': {'ordering': "('is_featured', 'ordering', 'title')", 'unique_together': "(('kind', 'video_id'),)", 'object_name': 'Video'},
            'channel_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['core.Competition']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_video_set'", 'null': 'True', 'to': u"orm['core.User']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'image': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'image_maxres': ('django.db.models.fields.URLField', [], {'max_length': '200', 'blank': 'True'}),
            'is_agency_video': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'is_featured': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'kind': ('django.db.models.fields.PositiveSmallIntegerField', [], {'default': '1'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'auto_now_add': 'True', 'blank': 'True'}),
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'modified_video_set'", 'null': 'True', 'to': u"orm['core.User']"}),
