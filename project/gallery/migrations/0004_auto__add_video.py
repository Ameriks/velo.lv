...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'gallery_video', (
            ...
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_video_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_video_set', null=True, to=orm['core.User'])),
            ...
            ('channel_title', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ...
            ('is_agency_video', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('ordering', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('image_maxres', self.gf('django.db.models.fields.URLField')(max_length=200, blank=True)),
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'31c4cb93-3569-42d3-8967-5c9ee59e8ff0'", 'max_length': '36'}),
        ...
        u'gallery.video': {
            'Meta': {'ordering': "('is_featured', 'ordering', 'title')", 'object_name': 'Video'},
