...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'PhotoNumber'
        db.create_table(u'gallery_photonumber', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_photonumber_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_photonumber_set', null=True, to=orm['core.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('photo', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['gallery.Photo'])),
            ('number', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['registration.Number'])),
            ('x1', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('y1', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('x2', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('y2', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
        ))
        db.send_create_signal(u'gallery', ['PhotoNumber'])

        # Adding model 'Album'
        db.create_table(u'gallery_album', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_album_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_album_set', null=True, to=orm['core.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
            ('title', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('gallery_date', self.gf('django.db.models.fields.DateField')()),
            ('photographer', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('folder', self.gf('django.db.models.fields.FilePathField')(path='media/gallery/', max_length=100, recursive=True)),
            ('competition', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['core.Competition'], null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('primary_image', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='primary_album', unique=True, null=True, to=orm['gallery.Photo'])),
        ))
        ...
        db.create_table(u'gallery_photo', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('created_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_photo_set', null=True, to=orm['core.User'])),
            ('modified_by', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='modified_photo_set', null=True, to=orm['core.User'])),
            ('created', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('modified', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, auto_now_add=True, blank=True)),
    ...
    def backwards(self, orm):
        # Deleting model 'PhotoNumber'
        db.delete_table(u'gallery_photonumber')
    ...
    models = {
        ...
        u'core.user': {
            ...
            'email_validation_code': ('django.db.models.fields.CharField', [], {'default': "'7b3eadf2-dfdb-4c65-a9de-b575ba87ad72'", 'max_length': '36'}),
